...
class RoomDetail extends Component {
  ...
  async componentDidMount() {
    //AÑADIDO ROOM ID
    const room = await DataService.getRoomsDetail(
      "rooms",
        ...
        <div className="container-esquema">
          <ul className="picto-text-info">
            <li className="presentation">
              <img src={padlock01} className="padlok" width="52%" />
              <p className="name-picto"> Please fill in your details</p>
            </li>

            <li className="presentation">
              <img src={padlock02} className="padlok" width="60%" />
              <p className="name-picto">Make your payment</p>
            </li>

            <li className="presentation">
              <img src={padlock03} className="padlok" width="60%" />
              <p className="name-picto">Payment completed</p>
            </li>
          </ul>
          <div className="line-esquema" />
        </div>

        <div>
          <h3 className="tittle-principal">
            <u>Please fill in your details</u>
          </h3>
        </div>
          ...
          <div className="roomdetail-map-description">
            {!loading && (
              <div className="detail-room">
                ...
                <div className="room-description-roomdetail">
                  {room.descriptionDetail}{" "}
                </div>
              </div>
            )}
            ...
            <ul className="list-picto-ventajas">
              <li>
                ...
                <span className="round-tab">
                  <img
                    src="https://image.flaticon.com/icons/png/512/82/82646.png"
                    alt="padlok"
                    width="15%"
                    className="image-picto-about"
                  />
              ...
              <li>
                ...
                <span className="round-tab">
                  <img
                    src="https://image.flaticon.com/icons/png/512/70/70482.png"
                    alt="padlok"
                    width="15%"
                    className="image-picto-about"
                  />
              ...
              <li>
                ...
                <span className="round-tab">
                  <img
                    src="https://image.flaticon.com/icons/png/512/91/91834.png"
                    alt="padlok"
                    width="15%"
                    className="image-picto-about"
                  />
              ...
              <li>
                ...
                <span className="round-tab">
                  <img
                    src="https://image.flaticon.com/icons/png/512/85/85966.png"
                    alt="padlok"
                    width="15%"
                    className="image-picto-about"
                  />
